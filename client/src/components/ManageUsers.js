...
function ManageUsers() {
    ...
    return (
        <div>
            ...
            {success && <div className="text-center bg-green-500/20 text-green-400 p-3 rounded-lg mb-4">{success}</div>}
            {error && <div className="text-center bg-red-500/20 text-red-400 p-3 rounded-lg mb-4">{error}</div>}
                                    ...
                                    <tr key={user._id} className="hover:bg-gray-800 transition-colors">
                                        ...
                                        <td className="p-4">
                                            <div className="flex gap-4">
                                                ...
                                                <button onClick={() => handleDeleteUser(user._id)} className="text-red-500 hover:text-red-400 transition-colors"><Trash2 size={18} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
